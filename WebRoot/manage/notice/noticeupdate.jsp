...
<TABLE cellSpacing=0 cellPadding=0 width="60%" align=center border=1>
    ...
    <TD align="center"> 
    <input  type="text" name="biaoti"  id='biaotiid'  size="30" value="${bean.biaoti }" />  </select><span style="color: red;">*</span>
    ...
    <TD align="center"> 
    <textarea rows="7" cols="50"  name="content"  id="contentid">${bean.content }</textarea>  </select><span style="color: red;">*</span>
